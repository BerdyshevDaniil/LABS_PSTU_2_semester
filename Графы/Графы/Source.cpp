...
int main() {
	...
	Graph<int> G;
	RenderWindow Window(VideoMode(800, 600), "PUTESHESTVENNIK");
	Window.setVerticalSyncEnabled(true);

	Button AddVertexButton("Add vertex", Window, 10);
	Button AddEdgeButton("Add edge", Window, 50);
	Button DeleteButton("Delete", Window, 90);
	Button MatrixButton("Matrix", Window, 130);
	Button BFSButton("BFS", Window, 170);
	Button DFSButton("DFS", Window, 210);
	Button DijkstraButton("Dijkstra", Window, 250);
	Button SalesmanButton("TMT", Window, 290);
	...
	int ind = 1;
	Image icon;
	if (!icon.loadFromFile("travelingman1.jpg")) exit(777);
	Window.setIcon(598, 571, icon.getPixelsPtr());
